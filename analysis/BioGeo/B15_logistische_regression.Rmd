...
Kategorie Geschlecht noch umformen, da zur Zeit männl, weibl, other gibt. Sagen wir doch einfach, dass binäre Menschen und nicht-binäre ("other") getrennt werden:
...
Anders als bei der linearen Regression können die Koeffizienten nicht direkt interpretiert werden. Die Koeffizientengeben uns einzig die Richtung des Zusammenhangs an. 
 ...
 - Dass man auf dem College JDDFP war, verkleinert die Chance, dass man ein Kopftuch trägt. Das ist allerdings leider keine signifikante Erkenntnis, da der p-Wert über 0.05 liegt.
 
 - Für jedes Tattoo mehr das man hat, steigt die Chance, dass man ein Kopftuch trägt und das ist tatsächlich ein hochsignifikantes Ergebnis!
 
 - Wenn man männlich ist, steigt die Chance, ein Kopftuch zu tragen, aber auch das ist nicht signifikant und
 
 - wenn man ein "anderes" Geschlecht hat, sinkt die Chance ein Kopftuch zu tragen und das ist hochsignifikant.
...
Darunter finden wir weitere Hinweise auf, wie gut das Modell passt. 
 ...
 - AIC (Akaikes Informationskriterium): Ebenfalls ein Güßtemaß, kann genutzt werden, um die Güte verschiedener Modelle miteinander zu vergleichen.
...
Eine Person mit Tattoos hat eine 1,95-fach höhere Chance ein Kopftuch zu tragen als eine Person ohne.
