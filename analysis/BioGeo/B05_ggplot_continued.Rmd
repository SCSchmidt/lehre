...
ggplot(data = penguins)+
  geom_boxplot(aes(x = species, y = body_mass_g), na.rm = TRUE) + 
  labs(x ="Art",
       y ="Gewicht",
...
Probiert doch einmal noch 2-3 andere Parameter aus, ob die vielleicht auch einen Unterschied zwischen den Arten erkennen lassen?
