...
(Lit zB: https://www.politikwissenschaften.ch/pdf.php?id=9
)
...
Das ist natürlich auch eine verkürzte Darstellung, aber wir sehen, dass das Konfidenzintervall am Anfang deutlich breiter ist und bei Werten über 10 die Chance sehr hoch ist, dass

### noch einmal
Pinguine. Versuchen wir das noch einmal mit dem Pinguindatensatz. Können wir vllt das Geschlecht vorhersagen (binär), indem wir uns das Gewicht (1.Parameter) und die Länge der Flossen (2.Parmeter) anschauen (beide metrisch)? 
...
2. Logit berechnen: **Aufgabe** Füllt diese Syntax aus und berechnet das logit!
```
...
5. Berechnet die Veränderung der Chance, wenn das Gewicht zwischen 4000-5000 oder 5000 - 6000 liegt, die Länge der Flossen aber der Mittelwert bleibt.
