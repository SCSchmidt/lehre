...
Als erstes checken wir alle Voraussetzungen: 1. Sind die Daten in den jeweiligen Gruppen normalverteilt?
...
Testen wir also als nächstes, ob die Varianz in den Gruppen gleich ist. Dafür nehmen wir den leveneTest aus dem Paket `car`. Wir stellen die abhängige metrische Variablen den beiden kategorialen Faktoren gegenüber:
...
**Aufgabe: Als Übung versucht doch das gleiche noch einmal herauszufinden für das Gewicht der Piraten.**
