...
Fangen wir in einem Dokument von oben an. Ganz oben steht ein sogenannter "YAML-Header". Er beginn und endet mit 3 Minuszeichen in einer eigenen Zeile. In ihm werden einige Meta-Daten zu dem Dokument abgelegt:
 ...
 - und mit `output:` wird spezifiziert, in was für eine Art Dokument das Rmarkdown-Dokument verwandelt werden soll. "html_document" wurde hier gewählt, es geht aber auch "word_document" oder "pdf_document" und tatsächlich noch eine R-Markdown spezifische Versionen, die hier nicht so wichtig sind.

Wenn das Paket `knitr` installiert ist (bitte installiert es), gibt es oben den **Knit**-Knopf (englisch für stricken und das Symbol ist ein Wollknäul mit Stricknadeln), der das Dokument umwandelt. Wer faul ist wie ich, benutzt den Shortcut Strg+Umschalt+k.
