...
2. Berchnet die Lagemaße noch einmal für `penguins$flipper_length_mm`. 
...
**Aufgabe** Bitte berechnet Mittelwert, Median, Modus, Standardabweichung und Varianz von `normal`.
