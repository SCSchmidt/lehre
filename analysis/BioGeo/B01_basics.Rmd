...
```{r}
# erstellen eines neuen Datensatzes nur der Pnguinspezies Chinstrap
...
penguins %>%
  ...
  use_series(body_mass_g) %>%    # das sagt, nimm die Spalte species, braucht Paket magrittr
  mean()
