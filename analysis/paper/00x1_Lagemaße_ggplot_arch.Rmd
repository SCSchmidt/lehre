...
Um den Hinweis von Arne nachzugehen, so geht das mit die Säulen sollen nebeneinander stehen:
...
Wenn ggplot genutzt wurde, um eine Grafik zu erstellen, kann man direkt danach den ggsave-Befehl nutzen. Er speichert immer das letzte erstellte ggplot ab. Man kann eine Reihe von Argumenten hinzugeben, wie die DPI-Anzahl, Größe in Breite und Höhe. Das wichtigste ist jedoch der Name der Datei, die erstellt werden soll mitsamt der richtigen Endung (jpg oder png o.ä.)
